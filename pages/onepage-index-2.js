...
const OnePageIndex2 = () => {
  const singleMenus = [
    ...
    { name: "Contact", href: "onepage-contact" },
  ];
  return (
    <Layout
      header={2}
      footer={2}
      extraBodyCls="home-two"
      singleMenus={singleMenus}
    >
      {/*====== Start Hero Section ======*/}
      <section className="banner-two" id="onepage-home">
        {/*=== Hero Slider ===*/}
      ...
      {/*====== Start About Section ======*/}
      <section className="about-area pb-80" id="onepage-about">
        <div className="container">
          <div className="row">
      ...
      <section className="project-section pt-125" id="onepage-project">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xl-8 col-lg-10">
              {/*=== Common Heading ===*/}
      ...
      {/*====== Start Team Section ======*/}
      <section className="team-section pt-125 pb-90" id="onepage-team">
        <div className="container">
          <div className="row justify-content-center">
      ...
      {/*====== Start Blog Section ======*/}
      <section className="blog-section pb-70 p-r z-1" id="onepage-blog">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xl-8 col-lg-10">
              {/*=== Common Heading ===*/}
      ...
      <section className="contact-section p-r pt-60 pb-80" id="onepage-contact">
        <div className="container">
          <div className="row">
            <div className="col-lg-7">
              {/*=== Map Content Box ===*/}
